...
+MNTSQ株式会社（ 以下、「甲」という。） と、B商事株式会社（以下、「乙」という。）とは、甲が権利を有する「○○○○」に関わる商標と「○○○○」に関わる著作物とに関する使用許諾契約（以下「本契約」という）を、次のとおり締結する。
...
+１. 第三者から差押、仮差押、競売、破産、会社整理、民事再生、特別清算又は会社更生手続の開始等の申立または公訴公課の滞納処分を受けたとき
+２. 自ら破産宣告、会社整理、民事再生手続、特別清算又は会社更生手続の開始等の申立を行ったとき
+３. 本件著作物を使用することにより、新たに著作物が発生した場合にはその権利は甲が保有するとき
+４. 金融機関から取引停止処分を受けたとき、自ら振出し、または引き受けた手形、小切手が不渡り処分になる等、支払いが不能な状態になったとき。
+５. 監督官庁より営業の取消、停止等の処分を受けたとき
+６. その他契約を継続しがたい重大な事由が生じたとき
+
 第１１条（改良著作物）
