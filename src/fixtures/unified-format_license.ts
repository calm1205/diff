...
+２．甲は、乙が第４条の使用ガイドラインを遵守せずに本件商標及び本件著作物を使用していると判断した場合は、いつでも、乙に対し、書面にてその旨を通知し且つ使用ガイドラインの基準に適合させるための改善措置と当該商品の販売・製造及び流通の停止を要求できるものとする。その場合、乙は、当該書面受領後速やかに改善措置を講じるものとし、且つ、当該改善措置により基準に適合するまでの間、当該商品の販売・製造及
び流通を停止する。
+
 第５条（販 売）
...
記録を提出し報告しなければならない。
-２．甲は、乙が第４条の使用ガイドラインを遵守せずに本件商標及び本件著作物を使用していると判断した場合は、いつでも、乙に対し、書面にてその旨を通知し且つ使用ガイドラインの基準に適合させるための改善措
置と当該商品の販売・製造及び流通の停止を要求できるものとする。その場合、乙は、当該書面受領後速やかに改善措置を講じるものとし、且つ、当該改善措置により基準に適合するまでの間、当該商品の販売・製造及
び流通を停止する。
 
 第７条（契約有効期間）
 本契約は、平成○○年○○月○○日から平成○○年○○月○○日まで有効とする。但し期間満了の○○か月前までに甲乙いずれからも別段の意思表示ないときはさらに１年間有効とする。ただし、第８条又は第１０条の規定により早期
に終了した場合はこの限りではない。
