export const unifiedFormat = `--- a/src/original.txt
+++ b/src/original.txt
@@ -2,19 +2,19 @@
...
+吾輩はここで始めてニンゲンというものを見た。
+しかもあとで聞くとそれは書生というニンゲン中で一番獰悪どうあくな種族であったそうだ。
 この書生というのは時々我々を捕つかまえて煮にて食うという話である。
 しかしその当時は何という考もなかったから別段恐しいとも思わなかった。
 ただ彼の掌てのひらに載せられてスーと持ち上げられた時何だかフワフワした感じがあったばかりである。
-掌の上で少し落ちついて書生の顔を見たのがいわゆる人間というものの見始みはじめであろう。
+掌の上で少し落ちついて書生の顔を見たのがいわゆるニンゲンというものの見始みはじめであろう。
...
+これがニンゲンの飲む煙草たばこというものである事はようやくこの頃知った。
